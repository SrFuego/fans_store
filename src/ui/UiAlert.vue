    ...
    <div class="ui-alert" :class="classes" role="alert">
      <div class="ui-alert__body">
        <div class="ui-alert__icon" v-if="!removeIcon">
          <slot name="icon" v-if="!iconAccount">
          ...
          <div v-if="iconAccount" class="ui-alert__account"><img src="/static/img/all/sad_face.png"></div>
        </div>
        ...
        <div class="ui-alert__dismiss-button">
          <ui-close-button size="small" @click="dismissAlert" v-if="dismissible"></ui-close-button>
        </div>
      </div>
    </div>
  </transition>
