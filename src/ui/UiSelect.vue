            ...
            <div class="ui-select__display">
                ...
                >
                  <template v-if="hasDisplayText">
                    <div v-if="type === 'image'" class="ui-select__image">
                      <img :src="value.image">
                    </div>
                  </template>
                  <template v-if="!multiple">
                    <div class="ui-select__text-image">{{ hasDisplayText ? displayText : (hasFloatingLabel && isLabelInline) ? null : placeholder }}</div>
                  </template>
                  <template v-if="multiple">
                    <div class="ui-select__text-image">{{ placeholder }}</div>
                  </template>
                ...
                <ui-icon class="ui-select__dropdown-button">
                  <span class="icon-expand" :class="[showDropdown ? 'expand_more':'expand_less']"></span>
                </ui-icon>
            </div>
